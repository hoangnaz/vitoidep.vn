						 				...
						 				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 info_detail_product">
							 				...
							 				<table class="table table-bordered">
							 					...
							 					<tbody>
													...
													?>
							 						<tr>
                                                    	<td colspan="9"><p class="text-center">Xóa toàn bộ giỏ hàng hiện tại của bạn<a onclick="delete_all()">Tại đây</a></p></td>
                                                    </tr>
							 					</tbody>
							 				</table>
						 				...
						 				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						 					...
						 					<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3
						 					 info_shopping_cart_right">
						 						<a href="sub_add_product_import_bill.php"><p><i class="fa fa-arrow-circle-right fa-2x text-success" aria-hidden="true"></i> TIẾP TỤC THÊM SẢN PHẨM</p></a>
