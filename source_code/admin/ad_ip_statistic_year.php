      <?php
				...
				$list_order=$ad_select->query_statistic_year_import($year);
				...
				$list_all_order_follow_year=$ad_select->query_statistic_year_import_page($year,$posision,$limit);
				$total_money=0;
				$total_finish=0;
				$total_product=0;
				...
				?>
                   <div class="col-xs-12  col-lg-8 col-lg-offset-2">
                    <div class="panel panel-default">
                          <div class="panel-heading">  <h5 class="text-center">DANH SÁCH ĐƠN HÀNG NĂM
                        	<?php echo $year;?></h5></div>
                      ...
                      <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                              <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                <?php
                                	foreach($list_all_order_follow_year as $lst_im_bill)
									{
								?>
                                    <tr>
