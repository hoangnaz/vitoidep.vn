      <?php
                ...
                if(isset($_POST["sub_month_order"]))
				{
			
			
					 $month=date("m", strtotime($_POST['month_order']));
					 $year=date('Y',strtotime($_POST['month_order']));
				...
				$list_order=$ad_select->query_statistic_month_order($month,$year);
				...
				$list_all_order_follow_day=$ad_select->query_statistic_month_order_page($month,$year,$posision,$limit);
				$total_money=0;
				...
				?>
                   <div class="col-xs-12  col-lg-8 col-lg-offset-2">
                    <div class="panel panel-default">
                          <div class="panel-heading">  <h5 class="text-center">DANH SÁCH ĐƠN HÀNG THÁNG 
                        	<?php echo $month." NĂM ".$year;?></h5></div>
                          <div class="panel-body">
                          		<p>TỔNG SỐ ĐƠN HÀNG ĐÃ ĐẶT TRONG THỜI GIAN NÀY:<span class="text-info"> <?php echo $count ?> Đơn hàng</span></p>
                         	 	<p>TỔNG SỐ SẢN ĐƠN HÀNG ĐÃ GIAO:<span class="text-danger"> <?php echo $total_order_finish; ?> Đơn hàng</span></p>
