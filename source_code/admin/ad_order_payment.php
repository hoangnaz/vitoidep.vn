<?php
	...
	$lst_order_status_one=$ad_select->list_order_follow_status(2);
	...
	$list_order_follow_status=$ad_select->list_order_follow_status_page(2,$posision,$limit);
...
<!-- /.row -->
                 <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h4 class="text-center text-danger">DANH SÁCH ĐƠN HÀNG THANH TOÁN ONLINE CHƯA GIAO HÀNG</h4>
                                    ...
                                    <tr>
                                                  ...
                                                  <div class="modal-body">
                                                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 info_detail_product">
                                                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 info_account">
                                                         ...
                                                         <p ><i class="fa fa-2x fa-money" aria-hidden="true"></i>   Tình trạng: Đã thanh toán thành công, đang chờ giao hàng.</p>
                                                          </div>
                                                    </div>
                                                  </div>
                                                  <?php
                                          ...
                                          <div class="modal fade" id="upda<?php echo $lo_status->id_order; ?>">
                                            <div class="modal-dialog" style="width:50%" >
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                <form method="POST" action="ad_manipulation/update_order.php?id_order=<?php echo $lo_status->id_order; ?>&id_staff=<?php echo $lo_status->staff_in_charge; ?>&or_status=2">
                                          ...
                                          <div class="modal fade" id="upda_deliver<?php echo $lo_status->id_order; ?>">
                                            <div class="modal-dialog" style="width:50%" >
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                <form method="POST" action="ad_manipulation/update_order_deliver.php?id_order=<?php echo $lo_status->id_order; ?>&id_staff=<?php echo $lo_status->staff_in_charge; ?>&or_status=2">
                                                 <div class="col-lg-12" style="margin-top:20px;">
									   ...
									   ?>
                                        <td><a  onclick="confirm_succes_order('<?php echo $lo_status->id_order; ?>',<?php echo $lo_status->staff_in_charge ?>)"><i class="fa fa-check-square-o" aria-hidden="true"></i><a></td>
                                          <td><a  onclick="delete_order('<?php echo $lo_status->id_order; ?>',2)"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
