<?php
	...
	include_once 'template/user_info/user_info.php';
	...
	include_once 'template/master/partial/sign_in.php';
	include_once 'template/master/partial/sign_up.php';
	include_once 'template/master/partial/get_password.php';
