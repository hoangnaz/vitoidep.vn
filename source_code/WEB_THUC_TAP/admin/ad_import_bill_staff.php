<?php
	...
	$list_bill_import=$data_select->list_import_bill_follow_staff($_SESSION["info_staff"]["id_staff"]);
	...
	$lst_bill_import_pagination=$data_select->list_import_bill_follow_staff_page($_SESSION["info_staff"]["id_staff"],$posision,$limit);
...
<!-- /.row -->
                 <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h4 class="text-center text-uppercase">Danh phiếu đã nhập do bạn quản lý</h4>
                        <div class="table-responsive">
                              <table class="table table-hover table-striped">
                                <thead>
                                    <tr>
                                        <th width="150px"><p>Mã phiếu nhập</p></th>
                                        <th width="200px"><p>Ngày lập</p></th>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "$lst_im_bill->name_producer_publisher"; ?></td>
                                         ...
                                         <div class="modal fade" id="import-ib<?php echo $lst_im_bill->id_import_bill; ?>">
                                                     ...
                                                     <div class="modal-header">
                                                      ...
                                                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 info_detail_product">
                                                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 info_account">
                                                            ...
                                                            <p ><i class="fa fa-2x fa-address-book-o" aria-hidden="true"></i>   Địa chỉ nhà cung cấp: <?php echo "$lst_im_bill->producer_publisher_address"; ?></p>
                                                            <p ><i class="fa fa-2x fa-envelope-o" aria-hidden="true"> </i>   Email:  <?php echo $lst_im_bill->producer_publisher_email;?></p>
                           				...
                           				<td>
                                        <a href="b.php?id_bill_import=<?php echo $lst_im_bill->id_import_bill;?>"><i class="fa fa-floppy-o" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    <?php
									}
