      <?php
				...
				$list_order=$ad_select->query_statistic_year_order($year);
				...
				$list_all_order_follow_day=$ad_select->query_statistic_year_order_page($year,$posision,$limit);
				$total_money=0;
				...
				?>
                   <div class="col-xs-12  col-lg-8 col-lg-offset-2">
                    <div class="panel panel-default">
                          <div class="panel-heading">  <h5 class="text-center">DANH SÁCH ĐƠN HÀNG
                        	<?php echo " NĂM ".$year;?></h5></div>
