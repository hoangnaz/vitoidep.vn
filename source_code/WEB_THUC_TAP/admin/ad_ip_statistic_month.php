      <?php
                ...
                if(isset($_POST["sub_month"]))
				{
					 ...
					 $month=date("m", strtotime($_POST['month_import']));
					 $year=date('Y',strtotime($_POST['month_import']));
				...
				$list_order=$ad_select->query_statistic_month_import($month,$year);
				...
				$list_all_order_follow_month=$ad_select->query_statistic_month_import_page($month,$year,$posision,$limit);
				$total_money=0;
			$total_finish=0;
				$total_product=0;
                              ...
                              <table class="table table-hover table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th><p>Nhân viên quản lý phiếu </p></th>
                                        <th><p>Tổng tiền </p></th>
                                ...
                                <tbody>
                                <?php
                                	foreach($list_all_order_follow_month as $lst_im_bill)
									{
								?>
                                    <tr>
