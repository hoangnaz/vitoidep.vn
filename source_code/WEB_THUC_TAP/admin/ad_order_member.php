<?php
	...
	$lst_order_staff=$ad_select->list_order_follow_staff($_SESSION["info_staff"]["id_staff"]);
	...
	$list_order_follow_staff_page=$ad_select->list_order_follow_staff_page($_SESSION["info_staff"]["id_staff"],$posision,$limit);
...
<!-- /.row -->
                 <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h4 class="text-center">DANH SÁCH ĐƠN HÀNG CỦA BẠN</h4>
                              ...
                              <table class="table table-hover table-striped">
                                ...
                                <?php foreach(	$list_order_follow_staff_page as $lo_status)
                                    ...
                                    <tr>
                                        ...
                                        <td> <a  data-toggle="modal" href='a.php?id_order=<?php echo $lo_status->id_order; ?>' target="_blank"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
