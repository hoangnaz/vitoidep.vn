<?php
	...
	$info_find=explode(',',$_POST["content"]);
	$result_seacrh=$data->query_list_search_product($info_find[0],$info_find[1],$info_find[2],$info_find[3]);
	$result_seacrh_mobile=$data->query_list_search_product_mobile($info_find[0],$info_find[1],$info_find[2],$info_find[3]);
				                                   	 	 	...
				                                   	 	 	<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
				                                   	 	 		<table class="table table-hover">
				                                   	 	 			...
				                                   	 	 			<tbody>
																		  ...
																		  {
																			  ?>
                                                                              <p class="text-danger" style="font-size:18px;"><i class="fa fa-usd" aria-hidden="true"></i><?php echo number_format(($pdd->price_product)*(1-$pdd->promotion_product/100));?> VNĐ
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 hidden-xs">
						 ...
						 <?php
                                        ...
                                        <img src="admin/assert/pattern/sale.png"  width="160px;"/>
                                          ...
                                          <i class="fa fa-usd" aria-hidden="true" style="font-size:17px;"> <?php echo number_format(($pd->price_product)*(1-$pd->promotion_product/100));?> VNĐ</i> <span style="text-decoration:line-through; font-size:13px;"><?php echo number_format($pd->price_product);?></span></p>
										</div>
		                                       				<div class="col-md-3 col-lg-3 product_price_order">  <?php 
																		  if($pd->quantity_inventory >0)
																		  {
