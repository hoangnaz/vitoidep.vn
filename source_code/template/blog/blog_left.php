			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 title_name_blog">
				...
				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
					<div class="post">
						...
						<h2 class="post-title"><a href="blog-single.php">How To Wear Bright Shoes</a></h2>
						<div class="post-meta">
							<ul>
								<li>
						...
						<div class="post-content">
							...
							<a href="blog-single.php" class="btn btn-main">Continue Reading</a>
						</div>
				...
				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
					<div class="post">
						...
						<h2 class="post-title"><a href="blog-single.php">Two Ways To Wear Straight Shoes</a></h2>
						<div class="post-meta">
							<ul>
								<li>
									<i class="tf-ion-ios-calendar"></i> 20, MAR 2017
				...
				<div class="post">
					...
					<h2 class="post-title"><a href="blog-single.php">Making A Denim Statement</a></h2>
					<div class="post-meta">
						<ul>
							<li>
								<i class="tf-ion-ios-calendar"></i> 20, MAR 2017
				...
				<div class="post">
					...
					<h2 class="post-title"><a href="blog-single.php">Standard Video Post</a></h2>
					<div class="post-meta">
						<ul>
							<li>
								<i class="tf-ion-ios-calendar"></i> 20, MAR 2017
