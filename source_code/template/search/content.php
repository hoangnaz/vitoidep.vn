														...
														<div class="product-item">
															...
															<h4><a href="product-single.php"><?php echo $value->name_product;?></a></h4>
																	...
																	<div style="margin:auto;">
																		<button type="button" class=" btn-shopping-list " onclick="shopping_cart(<?php echo $value->id_product;?>)"><i class="fa fa-shopping-bag" aria-hidden="true"></i>Thêm vào giỏ</button>
