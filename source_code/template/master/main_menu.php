                ...
                <ul class="nav navbar-nav">
																...
																foreach ($blCatalog->lstSubProduct() as $keyCatalog => $valueCatalog) {
																	if($valueCatalog->status == 0 && !empty($valueCatalog))
																	{
																		?>
																				...
																				?>
																									<li><a
																													href="danh_sach_san_pham?sanpham=<?php echo $value->sub_catalog_id; ?>"><?php  echo $value->sub_catalog_name;?></a>
																									</li>
																									<?php	
																					}
																				?>
                    ...
                    <li class="dropdown dropdown-slide">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                            data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">Đại lý bán hàng
